...
const Dashboard = () => {
  ...
  const colors = ["#9333ea", "#d97706", "#dc2626", "#0284c7", "#15a34a"];
  ...
  const editTitle = async (e) => {
    ...
    setAllResumes(prev => prev.map(resume => resume._id === editResumeId ? {resume, title:title} : resume))
    setEditResumeId('')
    setTitle('')
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            <UploadCloud className="size-11 transition-all duration-300 p-2.5 bg-linear-to-br from-puple-300 to-purple-500 text-white rounded-full" />
        ...
        <hr className="border-slate-300 mt-6 sm:w-[305px]" />

        {/* available resumes */}
        <div className="grid grid-cols-2 sm:flex flex-wrap gap-4 mt-3">
          {allResumes.map((resume, index) => {
            ...
            return (
              <button
                ...
                style={{
                  background: `linear-gradient(123deg, ${baseColor}10, ${baseColor}40)`,
        ...
        {/* when the create resume button will be clicked */}
        {showCreateResume && (
          <form
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Select resume file
                  <div className="flex flex-col items-center justify-center gap-2 border group text-clste-400 border-slate-4000 border-dashed rounded-md p-4 py-10 my-4 hover:border-indigo-500 hover:text-indigo-700 cursor-pointer transition-colors">
                    {resume ? (
