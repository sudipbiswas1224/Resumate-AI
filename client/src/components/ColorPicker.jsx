  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-sm text-purple-600 bg-linear-tobr from-purple-50 to purple-100 ring-purple-300 hover:ring-trasition-all px-3 py-2 rounded-lg"
      >
